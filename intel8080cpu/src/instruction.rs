...
impl Instruction for Intel8080Instruction {
    ...
    fn get_cycles(&self) -> Result<Cycles, Error> {
        Ok(match self {
            ...
            Intel8080Instruction::Rst { value: _ } => single!(11),
...
impl From<Vec<u8>> for Intel8080Instruction {
    ...
    fn from(bytes: Vec<u8>) -> Intel8080Instruction {
        match bytes[0] {
            ...
            0xc7 => Intel8080Instruction::Rst { value: 1 },
            ...
            0xcf => Intel8080Instruction::Rst { value: 1 },
            ...
            0xd7 => Intel8080Instruction::Rst { value: 2 },
            ...
            0xdf => Intel8080Instruction::Rst { value: 3 },
            ...
            0xe7 => Intel8080Instruction::Rst { value: 4 },
            ...
            0xef => Intel8080Instruction::Rst { value: 5 },
            ...
            0xf7 => Intel8080Instruction::Rst { value: 6 },
            ...
            0xff => Intel8080Instruction::Rst { value: 7 },
            c => {
...
impl ToString for Intel8080Instruction {
    fn to_string(&self) -> String {
        match self {
            ...
            Intel8080Instruction::Rst { value } => format!("RST {}", value),
