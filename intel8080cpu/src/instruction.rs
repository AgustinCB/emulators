...
impl Instruction for Intel8080Instruction {
    fn size(&self) -> Result<u8, Error> {
        Ok(match self {
            ...
            Intel8080Instruction::Inr { .. } => 1,
            Intel8080Instruction::Dcr { .. } => 1,
            Intel8080Instruction::Mvi { .. } => 2,
            Intel8080Instruction::Rlc => 1,
            Intel8080Instruction::Dad { .. } => 1,
            Intel8080Instruction::Ldax { .. } => 1,
            Intel8080Instruction::Dcx { .. } => 1,
            Intel8080Instruction::Rrc => 1,
            Intel8080Instruction::Ral => 1,
            Intel8080Instruction::Rar => 1,
            Intel8080Instruction::Shld { .. } => 3,
            Intel8080Instruction::Daa => 1,
            Intel8080Instruction::Lhld { .. } => 3,
            Intel8080Instruction::Cma => 1,
            Intel8080Instruction::Sta { .. } => 3,
            Intel8080Instruction::Lda { .. } => 3,
            Intel8080Instruction::Stc => 1,
            Intel8080Instruction::Cmc => 1,
            Intel8080Instruction::Mov { .. } => 1,
            Intel8080Instruction::Hlt => 1,
            Intel8080Instruction::Add { .. } => 1,
            Intel8080Instruction::Adc { .. } => 1,
            Intel8080Instruction::Sub { .. } => 1,
            Intel8080Instruction::Sbb { .. } => 1,
            Intel8080Instruction::Ana { .. } => 1,
            Intel8080Instruction::Xra { .. } => 1,
            Intel8080Instruction::Ora { .. } => 1,
            Intel8080Instruction::Cmp { .. } => 1,
            Intel8080Instruction::Rnz => 1,
            Intel8080Instruction::Pop { .. } => 1,
            Intel8080Instruction::Jnz { .. } => 3,
            Intel8080Instruction::Jmp { .. } => 3,
            Intel8080Instruction::Cnz { .. } => 3,
            Intel8080Instruction::Push { .. } => 1,
            Intel8080Instruction::Adi { .. } => 2,
            Intel8080Instruction::Rst { .. } => 1,
            Intel8080Instruction::Rz => 1,
            Intel8080Instruction::Ret => 1,
            Intel8080Instruction::Jz { .. } => 3,
            Intel8080Instruction::Cz { .. } => 3,
            Intel8080Instruction::Call { .. } => 3,
            Intel8080Instruction::Aci { .. } => 2,
            Intel8080Instruction::Rnc => 1,
            Intel8080Instruction::Jnc { .. } => 3,
            Intel8080Instruction::Out { .. } => 2,
            Intel8080Instruction::Cnc { .. } => 3,
            Intel8080Instruction::Sui { .. } => 2,
            Intel8080Instruction::Rc => 1,
            Intel8080Instruction::Jc { .. } => 3,
            Intel8080Instruction::In { .. } => 2,
            Intel8080Instruction::Cc { .. } => 3,
            Intel8080Instruction::Sbi { .. } => 2,
            Intel8080Instruction::Rpo => 1,
            Intel8080Instruction::Jpo { .. } => 3,
            Intel8080Instruction::Xthl => 1,
            Intel8080Instruction::Cpo { .. } => 3,
            Intel8080Instruction::Ani { .. } => 2,
            Intel8080Instruction::Rpe => 1,
            Intel8080Instruction::Pchl => 1,
            Intel8080Instruction::Jpe { .. } => 3,
            Intel8080Instruction::Xchg => 1,
            Intel8080Instruction::Cpe { .. } => 3,
            Intel8080Instruction::Xri { .. } => 2,
            Intel8080Instruction::Rp => 1,
            Intel8080Instruction::Jp { .. } => 3,
            Intel8080Instruction::Di => 1,
            Intel8080Instruction::Cp { .. } => 3,
            Intel8080Instruction::Ori { .. } => 2,
            Intel8080Instruction::Rm => 1,
            Intel8080Instruction::Sphl => 1,
            Intel8080Instruction::Jm { .. } => 3,
            Intel8080Instruction::Ei => 1,
            Intel8080Instruction::Cm { .. } => 3,
            Intel8080Instruction::Cpi { .. } => 2,
        })
    }
...
impl From<Vec<u8>> for Intel8080Instruction {
    ...
    fn from(bytes: Vec<u8>) -> Intel8080Instruction {
        match bytes[0] {
            ...
            0x02 => Intel8080Instruction::Stax {
                register: RegisterType::B,
            },
            0x03 => Intel8080Instruction::Inx {
                register: RegisterType::B,
            },
            0x04 => Intel8080Instruction::Inr {
                source: Location::Register {
                    register: RegisterType::B,
                },
            },
            0x05 => Intel8080Instruction::Dcr {
                source: Location::Register {
                    register: RegisterType::B,
                },
            },
            0x06 => Intel8080Instruction::Mvi {
                source: Location::Register {
                    register: RegisterType::B,
                },
                byte: bytes[1],
            ...
            0x09 => Intel8080Instruction::Dad {
                register: RegisterType::B,
            },
            0x0a => Intel8080Instruction::Ldax {
                register: RegisterType::B,
            },
            0x0b => Intel8080Instruction::Dcx {
                register: RegisterType::B,
            },
            0x0c => Intel8080Instruction::Inr {
                source: Location::Register {
                    register: RegisterType::C,
                },
            },
            0x0d => Intel8080Instruction::Dcr {
                source: Location::Register {
                    register: RegisterType::C,
                },
            },
            0x0e => Intel8080Instruction::Mvi {
                source: Location::Register {
                    register: RegisterType::C,
                },
                byte: bytes[1],
            ...
            0x11 => Intel8080Instruction::Lxi {
                register: RegisterType::D,
                low_byte: bytes[1],
                high_byte: bytes[2],
            },
            0x12 => Intel8080Instruction::Stax {
                register: RegisterType::D,
            },
            0x13 => Intel8080Instruction::Inx {
                register: RegisterType::D,
            },
            0x14 => Intel8080Instruction::Inr {
                source: Location::Register {
                    register: RegisterType::D,
                },
            },
            0x15 => Intel8080Instruction::Dcr {
                source: Location::Register {
                    register: RegisterType::D,
                },
            },
            0x16 => Intel8080Instruction::Mvi {
                source: Location::Register {
                    register: RegisterType::D,
                },
                byte: bytes[1],
            ...
            0x19 => Intel8080Instruction::Dad {
                register: RegisterType::D,
            },
            0x1a => Intel8080Instruction::Ldax {
                register: RegisterType::D,
            },
            0x1b => Intel8080Instruction::Dcx {
                register: RegisterType::D,
            },
            0x1c => Intel8080Instruction::Inr {
                source: Location::Register {
                    register: RegisterType::E,
                },
            },
            0x1d => Intel8080Instruction::Dcr {
                source: Location::Register {
                    register: RegisterType::E,
                },
            },
            0x1e => Intel8080Instruction::Mvi {
                source: Location::Register {
                    register: RegisterType::E,
                },
                byte: bytes[1],
            ...
            0x21 => Intel8080Instruction::Lxi {
                register: RegisterType::H,
                low_byte: bytes[1],
                high_byte: bytes[2],
            },
            0x22 => Intel8080Instruction::Shld {
                address: [bytes[1], bytes[2]],
            },
            0x23 => Intel8080Instruction::Inx {
                register: RegisterType::H,
            },
            0x24 => Intel8080Instruction::Inr {
                source: Location::Register {
                    register: RegisterType::H,
                },
            },
            0x25 => Intel8080Instruction::Dcr {
                source: Location::Register {
                    register: RegisterType::H,
                },
            },
            0x26 => Intel8080Instruction::Mvi {
                source: Location::Register {
                    register: RegisterType::H,
                },
                byte: bytes[1],
            ...
            0x29 => Intel8080Instruction::Dad {
                register: RegisterType::H,
            },
            0x2a => Intel8080Instruction::Lhld {
                address: [bytes[1], bytes[2]],
            },
            0x2b => Intel8080Instruction::Dcx {
                register: RegisterType::H,
            },
            0x2c => Intel8080Instruction::Inr {
                source: Location::Register {
                    register: RegisterType::L,
                },
            },
            0x2d => Intel8080Instruction::Dcr {
                source: Location::Register {
                    register: RegisterType::L,
                },
            },
            0x2e => Intel8080Instruction::Mvi {
                source: Location::Register {
                    register: RegisterType::L,
                },
                byte: bytes[1],
            ...
            0x31 => Intel8080Instruction::Lxi {
                register: RegisterType::Sp,
                low_byte: bytes[1],
                high_byte: bytes[2],
            },
            0x32 => Intel8080Instruction::Sta {
                address: [bytes[1], bytes[2]],
            },
            0x33 => Intel8080Instruction::Inx {
                register: RegisterType::Sp,
            },
            0x34 => Intel8080Instruction::Inr {
                source: Location::Memory,
            },
            0x35 => Intel8080Instruction::Dcr {
                source: Location::Memory,
            },
            0x36 => Intel8080Instruction::Mvi {
                source: Location::Memory,
                byte: bytes[1],
            },
            0x37 => Intel8080Instruction::Stc,
            0x39 => Intel8080Instruction::Dad {
                register: RegisterType::Sp,
            },
            0x3a => Intel8080Instruction::Lda {
                address: [bytes[1], bytes[2]],
            },
            0x3b => Intel8080Instruction::Dcx {
                register: RegisterType::Sp,
            },
            0x3c => Intel8080Instruction::Inr {
                source: Location::Register {
                    register: RegisterType::A,
                },
            },
            0x3d => Intel8080Instruction::Dcr {
                source: Location::Register {
                    register: RegisterType::A,
                },
            },
            0x3e => Intel8080Instruction::Mvi {
                source: Location::Register {
                    register: RegisterType::A,
                },
                byte: bytes[1],
            ...
            0x46 => Intel8080Instruction::Mov {
                destiny: Location::Register {
                    register: RegisterType::B,
                },
                source: Location::Memory,
            },
            0x47 => Intel8080Instruction::Mov {
                destiny: Location::Register {
                    register: RegisterType::B,
                },
                source: Location::Register {
            ...
            0x4e => Intel8080Instruction::Mov {
                destiny: Location::Register {
                    register: RegisterType::C,
                },
                source: Location::Memory,
            },
            0x4f => Intel8080Instruction::Mov {
                destiny: Location::Register {
                    register: RegisterType::C,
                },
                source: Location::Register {
            ...
            0x56 => Intel8080Instruction::Mov {
                destiny: Location::Register {
                    register: RegisterType::D,
                },
                source: Location::Memory,
            },
            0x57 => Intel8080Instruction::Mov {
                destiny: Location::Register {
                    register: RegisterType::D,
                },
                source: Location::Register {
            ...
            0x5e => Intel8080Instruction::Mov {
                destiny: Location::Register {
                    register: RegisterType::E,
                },
                source: Location::Memory,
            },
            0x5f => Intel8080Instruction::Mov {
                destiny: Location::Register {
                    register: RegisterType::E,
                },
                source: Location::Register {
            ...
            0x66 => Intel8080Instruction::Mov {
                destiny: Location::Register {
                    register: RegisterType::H,
                },
                source: Location::Memory,
            },
            0x67 => Intel8080Instruction::Mov {
                destiny: Location::Register {
                    register: RegisterType::H,
                },
                source: Location::Register {
            ...
            0x6e => Intel8080Instruction::Mov {
                destiny: Location::Register {
                    register: RegisterType::L,
                },
                source: Location::Memory,
            },
            0x6f => Intel8080Instruction::Mov {
                destiny: Location::Register {
                    register: RegisterType::L,
                },
                source: Location::Register {
            ...
            0x70 => Intel8080Instruction::Mov {
                destiny: Location::Memory,
                source: Location::Register {
                    register: RegisterType::B,
                },
            },
            0x71 => Intel8080Instruction::Mov {
                destiny: Location::Memory,
                source: Location::Register {
                    register: RegisterType::C,
                },
            },
            0x72 => Intel8080Instruction::Mov {
                destiny: Location::Memory,
                source: Location::Register {
                    register: RegisterType::D,
                },
            },
            0x73 => Intel8080Instruction::Mov {
                destiny: Location::Memory,
                source: Location::Register {
                    register: RegisterType::E,
                },
            },
            0x74 => Intel8080Instruction::Mov {
                destiny: Location::Memory,
                source: Location::Register {
                    register: RegisterType::H,
                },
            },
            0x75 => Intel8080Instruction::Mov {
                destiny: Location::Memory,
                source: Location::Register {
                    register: RegisterType::L,
                },
            },
            0x76 => Intel8080Instruction::Hlt,
            0x77 => Intel8080Instruction::Mov {
                destiny: Location::Memory,
                source: Location::Register {
                    register: RegisterType::A,
                },
            },
            0x78 => Intel8080Instruction::Mov {
                destiny: Location::Register {
                    register: RegisterType::A,
                },
                source: Location::Register {
            ...
            0x7e => Intel8080Instruction::Mov {
                destiny: Location::Register {
                    register: RegisterType::A,
                },
                source: Location::Memory,
            },
            0x7f => Intel8080Instruction::Mov {
                destiny: Location::Register {
                    register: RegisterType::A,
                },
                source: Location::Register {
            ...
            0x80 => Intel8080Instruction::Add {
                source: Location::Register {
                    register: RegisterType::B,
                },
            },
            0x81 => Intel8080Instruction::Add {
                source: Location::Register {
                    register: RegisterType::C,
                },
            },
            0x82 => Intel8080Instruction::Add {
                source: Location::Register {
                    register: RegisterType::D,
                },
            },
            0x83 => Intel8080Instruction::Add {
                source: Location::Register {
                    register: RegisterType::E,
                },
            },
            0x84 => Intel8080Instruction::Add {
                source: Location::Register {
                    register: RegisterType::H,
                },
            },
            0x85 => Intel8080Instruction::Add {
                source: Location::Register {
                    register: RegisterType::L,
                },
            },
            0x86 => Intel8080Instruction::Add {
                source: Location::Memory,
            },
            0x87 => Intel8080Instruction::Add {
                source: Location::Register {
                    register: RegisterType::A,
                },
            },
            0x88 => Intel8080Instruction::Adc {
                source: Location::Register {
                    register: RegisterType::B,
                },
            },
            0x89 => Intel8080Instruction::Adc {
                source: Location::Register {
                    register: RegisterType::C,
                },
            },
            0x8a => Intel8080Instruction::Adc {
                source: Location::Register {
                    register: RegisterType::D,
                },
            },
            0x8b => Intel8080Instruction::Adc {
                source: Location::Register {
                    register: RegisterType::E,
                },
            },
            0x8c => Intel8080Instruction::Adc {
                source: Location::Register {
                    register: RegisterType::H,
                },
            },
            0x8d => Intel8080Instruction::Adc {
                source: Location::Register {
                    register: RegisterType::L,
                },
            },
            0x8e => Intel8080Instruction::Adc {
                source: Location::Memory,
            },
            0x8f => Intel8080Instruction::Adc {
                source: Location::Register {
                    register: RegisterType::A,
                },
            },
            0x90 => Intel8080Instruction::Sub {
                source: Location::Register {
                    register: RegisterType::B,
                },
            },
            0x91 => Intel8080Instruction::Sub {
                source: Location::Register {
                    register: RegisterType::C,
                },
            },
            0x92 => Intel8080Instruction::Sub {
                source: Location::Register {
                    register: RegisterType::D,
                },
            },
            0x93 => Intel8080Instruction::Sub {
                source: Location::Register {
                    register: RegisterType::E,
                },
            },
            0x94 => Intel8080Instruction::Sub {
                source: Location::Register {
                    register: RegisterType::H,
                },
            },
            0x95 => Intel8080Instruction::Sub {
                source: Location::Register {
                    register: RegisterType::L,
                },
            },
            0x96 => Intel8080Instruction::Sub {
                source: Location::Memory,
            },
            0x97 => Intel8080Instruction::Sub {
                source: Location::Register {
                    register: RegisterType::A,
                },
            },
            0x98 => Intel8080Instruction::Sbb {
                source: Location::Register {
                    register: RegisterType::B,
                },
            },
            0x99 => Intel8080Instruction::Sbb {
                source: Location::Register {
                    register: RegisterType::C,
                },
            },
            0x9a => Intel8080Instruction::Sbb {
                source: Location::Register {
                    register: RegisterType::D,
                },
            },
            0x9b => Intel8080Instruction::Sbb {
                source: Location::Register {
                    register: RegisterType::E,
                },
            },
            0x9c => Intel8080Instruction::Sbb {
                source: Location::Register {
                    register: RegisterType::H,
                },
            },
            0x9d => Intel8080Instruction::Sbb {
                source: Location::Register {
                    register: RegisterType::L,
                },
            },
            0x9e => Intel8080Instruction::Sbb {
                source: Location::Memory,
            },
            0x9f => Intel8080Instruction::Sbb {
                source: Location::Register {
                    register: RegisterType::A,
                },
            },
            0xa0 => Intel8080Instruction::Ana {
                source: Location::Register {
                    register: RegisterType::B,
                },
            },
            0xa1 => Intel8080Instruction::Ana {
                source: Location::Register {
                    register: RegisterType::C,
                },
            },
            0xa2 => Intel8080Instruction::Ana {
                source: Location::Register {
                    register: RegisterType::D,
                },
            },
            0xa3 => Intel8080Instruction::Ana {
                source: Location::Register {
                    register: RegisterType::E,
                },
            },
            0xa4 => Intel8080Instruction::Ana {
                source: Location::Register {
                    register: RegisterType::H,
                },
            },
            0xa5 => Intel8080Instruction::Ana {
                source: Location::Register {
                    register: RegisterType::L,
                },
            },
            0xa6 => Intel8080Instruction::Ana {
                source: Location::Memory,
            },
            0xa7 => Intel8080Instruction::Ana {
                source: Location::Register {
                    register: RegisterType::A,
                },
            },
            0xa8 => Intel8080Instruction::Xra {
                source: Location::Register {
                    register: RegisterType::B,
                },
            },
            0xa9 => Intel8080Instruction::Xra {
                source: Location::Register {
                    register: RegisterType::C,
                },
            },
            0xaa => Intel8080Instruction::Xra {
                source: Location::Register {
                    register: RegisterType::D,
                },
            },
            0xab => Intel8080Instruction::Xra {
                source: Location::Register {
                    register: RegisterType::E,
                },
            },
            0xac => Intel8080Instruction::Xra {
                source: Location::Register {
                    register: RegisterType::H,
                },
            },
            0xad => Intel8080Instruction::Xra {
                source: Location::Register {
                    register: RegisterType::L,
                },
            },
            0xae => Intel8080Instruction::Xra {
                source: Location::Memory,
            },
            0xaf => Intel8080Instruction::Xra {
                source: Location::Register {
                    register: RegisterType::A,
                },
            },
            0xb0 => Intel8080Instruction::Ora {
                source: Location::Register {
                    register: RegisterType::B,
                },
            },
            0xb1 => Intel8080Instruction::Ora {
                source: Location::Register {
                    register: RegisterType::C,
                },
            },
            0xb2 => Intel8080Instruction::Ora {
                source: Location::Register {
                    register: RegisterType::D,
                },
            },
            0xb3 => Intel8080Instruction::Ora {
                source: Location::Register {
                    register: RegisterType::E,
                },
            },
            0xb4 => Intel8080Instruction::Ora {
                source: Location::Register {
                    register: RegisterType::H,
                },
            },
            0xb5 => Intel8080Instruction::Ora {
                source: Location::Register {
                    register: RegisterType::L,
                },
            },
            0xb6 => Intel8080Instruction::Ora {
                source: Location::Memory,
            },
            0xb7 => Intel8080Instruction::Ora {
                source: Location::Register {
                    register: RegisterType::A,
                },
            },
            0xb8 => Intel8080Instruction::Cmp {
                source: Location::Register {
                    register: RegisterType::B,
                },
            },
            0xb9 => Intel8080Instruction::Cmp {
                source: Location::Register {
                    register: RegisterType::C,
                },
            },
            0xba => Intel8080Instruction::Cmp {
                source: Location::Register {
                    register: RegisterType::D,
                },
            },
            0xbb => Intel8080Instruction::Cmp {
                source: Location::Register {
                    register: RegisterType::E,
                },
            },
            0xbc => Intel8080Instruction::Cmp {
                source: Location::Register {
                    register: RegisterType::H,
                },
            },
            0xbd => Intel8080Instruction::Cmp {
                source: Location::Register {
                    register: RegisterType::L,
                },
            },
            0xbe => Intel8080Instruction::Cmp {
                source: Location::Memory,
            },
            0xbf => Intel8080Instruction::Cmp {
                source: Location::Register {
                    register: RegisterType::A,
                },
            },
            0xc0 => Intel8080Instruction::Rnz,
            0xc1 => Intel8080Instruction::Pop {
                register: RegisterType::B,
            },
            0xc2 => Intel8080Instruction::Jnz {
                address: [bytes[1], bytes[2]],
            },
            0xc3 => Intel8080Instruction::Jmp {
                address: [bytes[1], bytes[2]],
            },
            0xc4 => Intel8080Instruction::Cnz {
                address: [bytes[1], bytes[2]],
            },
            0xc5 => Intel8080Instruction::Push {
                register: RegisterType::B,
            },
            ...
            0xfa => Intel8080Instruction::Jm {
                address: [bytes[1], bytes[2]],
            },
            0xfb => Intel8080Instruction::Ei,
            0xfc => Intel8080Instruction::Cm {
                address: [bytes[1], bytes[2]],
            },
